...
wenxin_ak = global_config.wenxin_ak
wenxin_sk = global_config.wenxin_sk
...
@draw_msg.handle()
async def _(bot: Bot, event: GroupMessageEvent, state: T_State):
    await draw_msg.finish('画画功能暂时关闭，敬请期待更新。')
